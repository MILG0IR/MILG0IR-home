<?php
	include_once($mg_dir['js']."remote/jquery.3.5.0.min.js.php");
	include_once($mg_dir['js']."remote/jquery-ui.1.12.0.min.js.php");
	...
	include_once($mg_dir['js']."remote/smoothscroll.0.4.0.min.js.php");

	include_once($mg_dir['js']."functions.js.php");
	include_once($mg_dir['js']."script.js.php");
?>