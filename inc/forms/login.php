<form id="loginform" class="login" onsubmit="return false;">
	...
	<button class="button-secondary" onclick="redirect('<?php echo$mg_dir['root']?>signup.php')">Go to signup</button>
	<p id="status"></p>
	<a href="<?php echo$mg_dir['root']?>forgot_password.php">Forgot Your Password?</a>
</form>