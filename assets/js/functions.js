<script name="FUNCTIONS">
	var api_key = "key";
	var toRoot = "<?php echo$mg_dir['root']?>"
	//--------------------------- Universal functions ---------------------------//
		function _(x) {
	...
	//--------------------------- TOAST CONTROL ---------------------------//
		function toast(type, heading, subheading, onClick) {
			if(type == "success") {
				var img = "<?php echo$mg_img['UI']['checked']['image']?>";
			} else if(type == "info") {
				var img = "<?php echo$mg_img['UI']['info']['image']?>";
			} else if(type == "warn") {
				var img = "<?php echo$mg_img['UI']['exclamation']['image']?>";
			} else if(type == "error") {
				var img = "<?php echo$mg_img['UI']['cancel']['image']?>";
			...
			var toast_close_image = document.createElement('img');
				toast_close_image.setAttribute('src', '<?php print($mg_img['UI']['close']['image']) ?>');
