				...
				/** PAGES  */
					/** Default */
						...
						.settings-wrapper > .settings-page > .panel {
							...
							margin: 1rem;
							width: 70%; }
						.settings-wrapper > .settings-page > .panel > input[type="button"] {
							padding: 0.4rem 1rem 0.4rem 1rem;
							float: right; }
						.settings-wrapper > .settings-page > .panel > h3 {
							display: inherit; }
				...
				<div class="settings-wrapper">
					...
					<div class="settings-page" id="users">
						...
						<div class="panel reference_codes">
							<h3>References</h3>
							<input type="button" class="secondary" value="Create reference code" onclick="createreference('<?php echo$user['username']?>')">
							<h4 id="ref"></h4>
							<p id="refstatus"></p>
							<table class="table table-unsortable table-striped table-hover table-references">
						...
						<div class="panel users">
							<h3>Users</h3>
							<table class="table table-unsortable table-striped table-hover table-users">
								<thead class="thead-dark">
									<tr>
										<th>ID</th>
										<th>Avatar</th>
						...
						<div class="panel ranks">
							<h3>Ranks</h3>
							<input type="button" class="primary" value="Save">
							<table class=" table table-sortable table-striped table-hover table-ranks">
								<thead class="thead-dark">
									<tr>
										<th>ID</th>
										<th>Icon</th>
					...
					<div class="settings-page" id="pages">
						...
						<div class="panel pages">
							<h3>Pages</h3>
							<input type="button" class="primary" value="Save">
							<table class="table table-sortable table-striped table-hover table-pages">
								<thead class="thead-dark">
									<tr>
										<th>ID</th>
										<th>Icon</th>
